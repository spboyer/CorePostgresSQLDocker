...
using CorePostgresSQLDocker.Repository;
using Microsoft.AspNetCore.Http;

namespace CorePostgresSQLDocker.Apis 
{
    ...
    public class CustomersServiceController : Controller
    {
        ...
        public async Task<ActionResult> Customers()
        {
            ...
            customers.Add(new Customer(){Id=999, FirstName="Shayne", LastName="Boyer", Email="shayneboyer@outlook.com"});
            return Ok(customers);
        }
